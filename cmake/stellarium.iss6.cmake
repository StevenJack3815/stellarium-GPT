; Stellarium installer (InnoSetup 6 compatible)
...
; Common (Administrative) or User (Non administrative) desktop
Name: "{autodesktop}\Stellarium"; Filename: "{app}\stellarium.exe"; WorkingDir: "{app}"; IconFilename: "{app}\data\stellarium.ico"; Tasks: desktopicon

[Registry]
; Set file associations for Stellarium scripts
Root: HKA; Subkey: "Software\Classes\.ssc"; ValueType: string; ValueName: ""; ValueData: "Stellarium.Script"; Flags: uninsdeletevalue
Root: HKA; Subkey: "Software\Classes\Stellarium.Script"; ValueType: string; ValueName: ""; ValueData: "Stellarium Script"; Flags: uninsdeletekey
Root: HKA; Subkey: "Software\Classes\Stellarium.Script\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\stellarium.exe,0"
Root: HKA; Subkey: "Software\Classes\Stellarium.Script\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\stellarium.exe"" --startup-script ""%1"""

; Recommended use Inno Setup 6.1.2+
[Languages]
